...
TARGET_WAR_APP_MAP["ufcolo1-app1"]="ufcolo1-app1-hit ufcolo1-app2-hit ufcolo1-app3-hit"
TARGET_WAR_APP_MAP["ufcolo2-app1"]="ufcolo2-app1-hit ufcolo2-app2-hit ufcolo2-app3-hit"
...
TARGET_DB_CLUSTER_NAME=hitprod
TARGET_DB_CLUSTER_VERSION=11

TARGET_DB_PRI_GROUPS="hit"
...
LINKS="https://ufcolo1-dmzprod1-webhit1-prod-$APP_VER.test.unifaun.com:4431"
