...
WAR_SERVERS="ufcolo1-app1 ufcolo2-app1"
WEB_SERVERS="ufcolo1-web1 ufcolo1-web2 ufcolo2-web1 ufcolo2-web2"
...
TARGET_HOSTS="ufcolo1-app1-${TARGET_NAME} ufcolo1-app2-${TARGET_NAME} ufcolo1-app2-${TARGET_NAME} ufcolo2-app2-${TARGET_NAME}"
